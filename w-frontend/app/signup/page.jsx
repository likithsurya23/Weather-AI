...
import { Cloud, ArrowLeft, Eye, EyeOff, User, Mail, Lock } from 'lucide-react';
...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col justify-center items-center px-4 py-12">
      {/* Main Form Card matching Wireframe Screen 11 */}
      <div className="w-full max-w-md bg-white/85 dark:bg-slate-900/85 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/80 rounded-3xl p-8 shadow-2xl transition-all relative">
        ...
        <div className="text-center mb-8 pt-2">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            Join WeatherWise and get personalized weather experience
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 bg-slate-900 hover:bg-slate-800 dark:bg-blue-600 dark:hover:bg-blue-700 text-white rounded-2xl font-bold text-sm shadow-md shadow-blue-500/10 transition-all cursor-pointer disabled:opacity-50 mt-2"
          >
